"""Mesh-building helpers for the Far Cry 3 importer.

These are FC3-OWNED copies of the small generic Blender mesh operations
...
that the Far Cry 3 import path is fully self-contained: editing FC3's
mesh behaviour can never affect Avatar / Far Cry 4 / Watch Dogs, and vice
