...
from .binary_fc2 import LE
from ..Core.debug import VerboseLogger as vlog, TraceLogger
from .import_uv_fc2 import apply_uv_layer, flip_face_winding
from .import_weights_fc2 import apply_vertex_weights
from .normals_fc2 import apply_split_normals, store_tangent_attributes
from .vertex_colors_fc2 import apply_vertex_colors
from .import_materials_fc2 import XBMParser
from .import_xbt_fc2 import XBTConverter
from .nodes_fc2 import BlenderMaterialSetup
...
def create_armature(skel, nb, reorient_bones=False):
    ...
    #     frame, not its rotation - empirically pinned on avatar_m_body,
    #     independent of MB2O, do not touch.
    #   root_world_full (translation + rotation) - feeds the MB2O bind-pose
    #     reconstruction further down. See modules/Avatar/blender_pipeline_avatar.py
    #     and agents.md "MB2O import-side verification" (2026-06-30): once
    #     bones are matched to the correct MB2O matrix (skeleton_fc2.py
    #     apply_bind_matrices), the ROOT'S FULL TRANSFORM is what
    #     reconstructs the same bind position EDON already gives directly.
